...
spiral(2.0, 5.0, 0.2).rotate(r1).modulateRotate( noise(0.75,0.015).ditherrndcolor() )
  .mult( spiral(1.0, 3.0, 0.2).color(0,0.75,0.75).modulateRotate( noise(0.75,0.020).ditherrndcolor() ) )
  .diff( spiral(2.0, 5.0, 0.15).rotate(r2).color(0.333,0,0).modulateRotate( noise(0.75,0.025).ditherrndcolor() ) )
  .diff( spiral(2.0, 5.0, 0.15/2.0).rotate(r3).color(0,0,0.333).modulateRotate( noise(0.75,0.030).ditherrndcolor() ) )
.rotate(r4)
  .dither2()
.out()
